...
test_priority_donate_multiple (void) 
{
  ...
  msg ("Main thread should have priority %d.  Actual priority: %d.",
       PRI_DEFAULT + 1, thread_current()->priority, thread_get_priority ());

  thread_create ("b", PRI_DEFAULT + 2, b_thread_func, &b);
  msg ("Main thread should have priority %d.  Actual priority: %d.",
       PRI_DEFAULT + 2, thread_current()->priority, thread_get_priority ());
  ...
  msg ("Main thread should have priority %d.  Actual priority: %d.",
       PRI_DEFAULT, thread_current()->priority, thread_get_priority ());
}
